...
function editarAnotacao(anotacao) {
  ...
  cadastrarButton.removeEventListener("click", adicionarAnotacao);
...
async function atualizarAnotacao(tituloOriginal) {
  ...
  try {
    ...
    cadastrarButton.addEventListener("click", adicionarAnotacao);
  } catch (error) {
...
//Criando componente button para ser passado no card
